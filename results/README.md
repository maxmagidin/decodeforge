...
| [Broader Apple M4 evaluation](evaluation/apple-m4-v1/README.md) | Native/reference correctness, Q8/FP32 sensitivity, and separate model timing | A consistent native speedup over FP32, or results on another host |
...
The summaries can be regenerated from the saved evidence. New performance
claims should keep their raw samples and rejected outcomes, and name exactly
what was timed and compared.
