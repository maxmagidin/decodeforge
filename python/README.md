...
| Opt-in decode diagnostics | [`decode_profile.py`](decodeforge/decode_profile.py), [`qproj_profile.py`](decodeforge/qproj_profile.py), [`profile_capture.py`](decodeforge/profile_capture.py), [`profile_analysis.py`](decodeforge/profile_analysis.py), [profiling guide](../docs/PROFILING.md) |
